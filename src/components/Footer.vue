            ...
            <div class="cont row">
                ...
                <div class="socials">
                    ...
                    <a href="https://cyb.ai/network/bostrom/contract/bostrom1ndwqfv2skglrmsqu4wlneepthyrquf9r7sx6r0" target="_blank" rel="noopener nofollow">
                        <svg viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="37" cy="37" r="37" fill="currentColor"/><circle cx="37" cy="37" r="18" fill="var(--color2)"/></svg>
                    </a>
                </div>

                <div class="line"></div>

                <div class="copyright">Bro & Bro team, 2025</div>
            </div>
        </div>
    </footer>
</template>
