<template>
    <header>
        <div class="cont row">
            ...
            <div class="address" v-if="!isWinner">
            ...
            <a v-else :href="`https://www.stargaze.zone/p/${convertAddress(store.user.address, 'stars')}/tokens`" target="_blank" rel="noopener nofollow" class="address gold">
