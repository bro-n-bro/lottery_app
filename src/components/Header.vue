    ...
    <header>
        <div class="cont row">
            ...
            <div class="menu">
                ...
                <div><button class="btn scroll_btn" data-anchor="steps">Steps to Win</button></div>
            </div>

            <!-- Connect wallet button -->
            <button class="connect_btn" @click.prevent="connectKeplr()" v-if="!store.isUserInfoGot" :class="{ process: store.isKeplrConnecting || store.showRegisterModal }">
            ...
            <div class="balance">
                ...
                <div class="tickets">
                    ...
                    <div class="referral">
                        <span>{{ store.user.referral_tickets + store.user.invitee_tickets }}</span>
            ...
            <div class="address" :class="{ gold: isWinner }">
                <svg viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="isWinner">
                    <path d="M23 8.56144V8.63917C23 9.55482 23 10.0137 22.793 10.3885C22.586 10.7633 22.209 10.9858 21.457 11.4319L20.664 11.9004C21.21 9.93279 21.393 7.81827 21.46 6.01039L21.47 5.77509L21.472 5.71973C22.123 5.96035 22.489 6.14029 22.717 6.47674C23 6.89517 23 7.45095 23 8.56144ZM3 8.56144V8.63917C3 9.55482 3 10.0137 3.207 10.3885C3.414 10.7633 3.791 10.9858 4.543 11.4319L5.337 11.9004C4.79 9.93279 4.607 7.81827 4.54 6.01039L4.53 5.77509L4.529 5.71973C3.877 5.96035 3.511 6.14029 3.283 6.47674C3 6.89517 3 7.45201 3 8.56144Z" fill="currentColor"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.3764 2.3697C15.9296 2.11736 14.4655 1.99378 12.9994 2.00024C11.2164 2.00024 9.7464 2.1674 8.6224 2.3697C7.4834 2.57412 6.9144 2.67633 6.4384 3.30025C5.9634 3.92418 5.9884 4.59814 6.0384 5.94606C6.2114 10.5754 7.1494 16.359 12.2494 16.87V18.5397H10.8194C10.5883 18.5398 10.3644 18.6252 10.1857 18.7813C10.0071 18.9373 9.88469 19.1544 9.8394 19.3957L9.64939 20.4029H6.9994C6.80048 20.4029 6.60972 20.4871 6.46907 20.6368C6.32841 20.7866 6.2494 20.9897 6.2494 21.2015C6.2494 21.4132 6.32841 21.6164 6.46907 21.7661C6.60972 21.9159 6.80048 22 6.9994 22H18.9994C19.1983 22 19.3891 21.9159 19.5297 21.7661C19.6704 21.6164 19.7494 21.4132 19.7494 21.2015C19.7494 20.9897 19.6704 20.7866 19.5297 20.6368C19.3891 20.4871 19.1983 20.4029 18.9994 20.4029H16.3494L16.1594 19.3957C16.1141 19.1544 15.9917 18.9373 15.8131 18.7813C15.6344 18.6252 15.4105 18.5398 15.1794 18.5397H13.7494V16.87C18.8494 16.359 19.7884 10.5765 19.9604 5.94606C20.0104 4.59814 20.0364 3.92311 19.5604 3.30025C19.0844 2.67633 18.5154 2.57412 17.3764 2.3697Z" fill="currentColor"/>
                </svg>

                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 24" fill="none" v-else>
...
<script setup>
    ...
    const store = useGlobalStore(),
        isWinner = computed(() => store.lastWinners.some(el => el.initial_delegator?.address === store.user.address))
...
<style scoped>
    ...
    {
        color: #5f2b00;
        background: linear-gradient(180deg, #ffce2b 0%, #ffe590 6.38%, #ffce2b 33.44%, #ffce2b 44.89%, #e7a006 74.79%, #d79300 86.97%, #d79300 100%);
    }
