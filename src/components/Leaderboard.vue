        ...
        <div class="cont">
            ...
            <div class="data">
                ...
                <div class="tabs">
                    ...
                    <!-- Tabs button -->
                    <button class="btn" @click.prevent="activeTab = 3" :class="{ active: activeTab === 3 }">Top Inviters</button>
                </div>
                ...
                <div class="tab_content last_winners" v-if="activeTab === 1">
                    ...
                    <div class="list" v-else-if="store.lastWinners.length">
                        ...
                        <a :href="`https://www.stargaze.zone/p/${convertAddress(winner.initial_delegator.address, 'stars')}/tokens`" target="_blank" rel="noopener nofollow" class="item" v-for="(winner, index) in store.lastWinners" :key="winner.id">
                            ...
                            <div class="staked">Staked: <span>{{ winner.amount_difference }} {{ store.currentNetwork.symbol }}</span></div>

                            <div class="tickets">
                                <span>{{ winner.total_tickets }}</span>
                ...
                <div class="tab_content top_inviters" v-if="activeTab === 3">
                    <!-- Loader -->
                    <TheLoader v-if="loading" />
                    ...
                    <div class="list" v-else>
                        <!-- Top staker -->
                        <div class="item" v-for="(inviter, index) in store.topInviters" :key="index">
                            <div class="number"></div>

                            <div class="address">{{ inviter.address.slice(0, 5) + '...' + inviter.address.slice(-6) }}</div>

                            <div class="tickets">
                                <span>{{ inviter.tickets }}</span>
...
<style scoped>
    ...
    .leaderboard .top_inviters .item .tickets
    {
        margin-left: auto;
    }
